  ...
  return (
    <div className="max-w-[1640px] mx-auto p-4 flex justify-between items-center">
      <div className="flex items-center">
        ...
        <div className="hidden lg:flex items-center rounded-full p-1 text-[14px] bg-gray-200">
      ...
      <div
        className={
          nav
            ? "fixed top-0 h-screen bg-white z-10 left-0 w-[300px] duration-300"
            : "fixed top-0 h-screen bg-white z-10 left-[-100%] w-[300px] duration-300"
        }
      >
        <AiOutlineClose
          onClick={() => setNav(!nav)}
